-- ============================================================================
-- SETUP COMPLETO - Base de Datos Supabase
-- ============================================================================
-- Ejecuta este script COMPLETO en el SQL Editor de Supabase
-- para configurar toda la base de datos desde cero
-- ============================================================================
...
-- 11. INSERTAR PREGUNTAS INICIALES (OPCIONAL)
-- ============================================================================
-- Puedes descomentar esto para tener preguntas de ejemplo

/*
INSERT INTO api.survey_questions (question_text, question_key, question_type, validation_rules, order_index, is_active)
VALUES 
    ('¿Cuál es tu nombre completo?', 'nombre', 'text', '{"required": true, "minLength": 2}', 1, true),
    ('¿Cuál es tu número de teléfono?', 'telefono', 'phone', '{"required": true, "pattern": "^[0-9]{10}$"}', 2, true),
    ('¿Qué regalo te gustaría recibir?', 'regalo', 'checkbox', '{"required": true}', 3, true),
    ('¿Dónde compraste tus regalos?', 'lugar_compra', 'select', '{"required": true}', 4, true),
    ('¿Cuánto gastaste aproximadamente?', 'gasto', 'select', '{"required": true}', 5, true)
...
WHERE table_schema = 'api' 
  AND table_name IN ('encuestas', 'survey_questions');
...
-- 3. Gestionar preguntas desde el dashboard
-- ============================================================================
