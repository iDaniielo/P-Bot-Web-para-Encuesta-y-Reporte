      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-6">
        ...
        {currentField.type === 'select' && currentField.options ? (
          ...
          <input
            ...
            className="w-full px-6 py-4 text-lg text-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-900 dark:text-white outline-none transition-all"
            autoFocus
          />
        )}
